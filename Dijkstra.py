...
class Grafo:
  def __init__(self):
    self.vertices = set() # A set is an unordered collection with no duplicate elements
...
if __name__ == '__main__':
	...
	arquivo = ler_arquivo('file.txt')
	
	if not arquivo:
		print 'O arquivo especificado não existe. Tente novamente.'
